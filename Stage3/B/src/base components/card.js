...
} , function isEqual( prevProp , curProp){ if( "compareDataOnly" in curProp && curProp["compareDataOnly"] === 1) return prevProp.data == curProp.data;  return shallowEqual(prevProp,curProp); } );
