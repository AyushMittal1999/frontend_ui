const Weekday = React.memo( function Weekday({day , constants, schedule  }){
    ...
    <div id={day}>
        ...
        <section className={`${day}-schedule__card-holder`}>
            ...
            <div className="day-schedule__two-card-group">
                ...
                return <Card key={m}  classes ={[`card ${m}` , `card__image-holder` , "card__text-holder"]}  img={{ src:`../resources/images/${m}.jpg`, alt:m} } data={ schedule[m] }  compareDataOnly = {1}  />
                })}
