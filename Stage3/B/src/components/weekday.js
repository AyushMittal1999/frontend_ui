        ...
        React.createElement(
            ...
            React.createElement(
                ...
                meals.slice(0, 2).map(function (m) {
                    return React.createElement(Card, { key: m, classes: ["card " + m, "card__image-holder", "card__text-holder"], img: { src: "../resources/images/" + m + ".jpg", alt: m }, data: schedule[m], compareDataOnly: 1 });
                })
            ),
            React.createElement(
                "div",
