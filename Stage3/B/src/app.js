function App( {dataService , constants}){
    ...
    return(
     <React.Fragment>
        ...
        <Modal constants={constants} visiblity={isModalVisible} displayModalHandler ={displayModalHandler} updateData={updateData} />
        
        <Today  constants={constants} schedule ={dataService.getDayData(todayDay)}/>
        ...
        .map( w  =>{ return <Weekday day={w} key={ w} constants={constants} schedule={ dataService.getDayData(w) }  /> } )}
