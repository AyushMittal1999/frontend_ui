...
function App(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement(Modal, { constants: constants, visiblity: isModalVisible, displayModalHandler: displayModalHandler, updateData: updateData }),
        React.createElement(Today, { constants: constants, schedule: dataService.getDayData(todayDay) }),
        ...
        weekdays.slice(weekdays.indexOf(todayDay), 7).concat(weekdays.slice(0, weekdays.indexOf(todayDay))).map(function (w) {
            return React.createElement(Weekday, { day: w, key: w, constants: constants, schedule: dataService.getDayData(w) });
        }),
