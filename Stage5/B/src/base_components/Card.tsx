...
interface CardProps {
  ...
  ulAttributes?: GenericObject;
  imgAttributes?: GenericObject;
  data: TodayCardData | CardData;
  compareDataOnly?: number;
}
...
const Card = React.memo(
  ...
  function isEqual(prevProp: CardProps, curProp: CardProps) {
